...
static s8 error1; // converted data to euler angles
static s8 error2;
...
void init_bno_1()
{
  ...
  sensor_1.bus_write = _imu_i2c_write;
  sensor_1.bus_read = _imu_i2c_read;
...
void init_bno_2()
{
    ...
    sensor_2.bus_write = _imu_i2c_write;
    sensor_2.bus_read = _imu_i2c_read;
